...
/* ── INTEGRANTES ───────────────────────────────────────── */
.int-card { background: #f8fafc; border: 1.5px solid var(--border); border-radius: 10px; padding: 14px; margin-bottom: 12px; position: relative; }
...
/* Familiograma canvas */
#familiograma-canvas { min-height: 220px; }
</style>
</head>
<body>
...
<div id="screen-app" class="screen">
  ...
  <div class="tab-panel active" id="panel-nuevo">
    ...
    <!-- ═══ FORMULARIO 1: CARTOGRAFÍAS ═══════════════════
         Spreadsheet: SHEETS_URLS[municipio].carto
         ═══════════════════════════════════════════════ -->
    ...
    <!-- ═══ FORMULARIO 2: RECOLECCIÓN ════════════════════
         Spreadsheet: SHEETS_URLS[municipio].recoleccion
         ═══════════════════════════════════════════════ -->
      ...
      <div class="qbody">
        ...
        <div class="sub-block" id="sub-familiograma">
          ...
          <div class="sub-body" id="subbody-familiograma">
            <p style="font-size:.82rem;color:var(--text-muted);margin-bottom:14px">Agregue familiar por familiar tomando como referencia una persona principal (caso índice). El familiograma se organiza alrededor de esa persona.</p>
            <div class="ff">
              <label>Tipo de Relación de Pareja (Persona principal)</label>
        ...
        <!-- SUB-ACORDEÓN: ADGAR -->
        <div class="sub-block" id="sub-adgar">
          <div class="sub-head" onclick="toggleSub('adgar')">
            <span class="sub-icon">📋</span>
            <span class="sub-title">ADGAR</span>
            <span class="sub-chev">▼</span>
          </div>
          <div class="sub-body" id="subbody-adgar" style="display:none">
            <p style="font-size:.82rem;color:var(--text-muted);margin-bottom:14px">Evaluación funcional del adulto mayor.</p>
            <div class="sdiv">Actividades Básicas de la Vida Diaria</div>
            <div class="ff"><label>¿Puede bañarse solo/a?</label><select id="adgar-banio"><option value="">—</option><option>Independiente</option><option>Necesita ayuda parcial</option><option>Dependiente total</option></select></div>
            <div class="ff"><label>¿Puede vestirse solo/a?</label><select id="adgar-vestir"><option value="">—</option><option>Independiente</option><option>Necesita ayuda parcial</option><option>Dependiente total</option></select></div>
            <div class="ff"><label>¿Puede usar el sanitario solo/a?</label><select id="adgar-sanitario"><option value="">—</option><option>Independiente</option><option>Necesita ayuda parcial</option><option>Dependiente total</option></select></div>
            <div class="ff"><label>¿Puede desplazarse solo/a dentro del hogar?</label><select id="adgar-desplazamiento"><option value="">—</option><option>Independiente</option><option>Necesita ayuda parcial</option><option>Dependiente total</option></select></div>
            <div class="ff"><label>¿Tiene continencia urinaria y fecal?</label><select id="adgar-continencia"><option value="">—</option><option>Continente</option><option>Incontinencia ocasional</option><option>Incontinente total</option></select></div>
            <div class="ff"><label>¿Puede alimentarse solo/a?</label><select id="adgar-alimentacion"><option value="">—</option><option>Independiente</option><option>Necesita ayuda parcial</option><option>Dependiente total</option></select></div>
            <div class="sdiv">Actividades Instrumentales</div>
            <div class="ff"><label>¿Puede manejar su dinero?</label><select id="adgar-dinero"><option value="">—</option><option>Independiente</option><option>Necesita supervisión</option><option>No puede</option></select></div>
            <div class="ff"><label>¿Puede tomar sus medicamentos correctamente?</label><select id="adgar-medicamentos"><option value="">—</option><option>Independiente</option><option>Necesita supervisión</option><option>No puede</option></select></div>
            <div class="ff"><label>¿Puede usar teléfono?</label><select id="adgar-telefono"><option value="">—</option><option>Sin dificultad</option><option>Solo llama a números conocidos</option><option>No puede usar teléfono</option></select></div>
            <div class="ff"><label>¿Puede hacer compras?</label><select id="adgar-compras"><option value="">—</option><option>Independiente</option><option>Necesita ayuda</option><option>No puede</option></select></div>
            <div class="ff"><label>Observaciones ADGAR</label><textarea id="adgar-obs" placeholder="Observaciones sobre funcionalidad del adulto mayor..."></textarea></div>
          </div>
        </div>
        ...
        <div class="sub-block" id="sub-zarit">
          ...
          <div class="sub-body" id="subbody-zarit" style="display:none">
            <p style="font-size:.82rem;color:var(--text-muted);margin-bottom:14px">Evalúa el nivel de sobrecarga del cuidador principal. Escala: 1=Nunca · 2=Casi nunca · 3=A veces · 4=Frecuentemente · 5=Casi siempre.</p>
        ...
        <div class="sub-block" id="sub-ecomapa">
          ...
          <div class="sub-body" id="subbody-ecomapa" style="display:none">
            <p style="font-size:.82rem;color:var(--text-muted);margin-bottom:14px">Identifica las relaciones de la familia con su entorno y redes de apoyo.</p>
            <div class="sdiv">Redes de Apoyo Institucional</div>
            <div class="ff"><label>Relación con el Sistema de Salud</label><select id="eco-salud"><option value="">—</option><option>Fuerte y positiva</option><option>Débil o tensa</option><option>Sin relación</option><option>En conflicto</option></select></div>
            <div class="ff"><label>Relación con Instituciones Educativas</label><select id="eco-educacion"><option value="">—</option><option>Fuerte y positiva</option><option>Débil o tensa</option><option>Sin relación</option><option>En conflicto</option></select></div>
            <div class="ff"><label>Relación con Entidades Gubernamentales (ICBF, alcaldía, etc.)</label><select id="eco-gobierno"><option value="">—</option><option>Fuerte y positiva</option><option>Débil o tensa</option><option>Sin relación</option><option>En conflicto</option></select></div>
            <div class="ff"><label>Relación con Iglesia o grupos religiosos</label><select id="eco-iglesia"><option value="">—</option><option>Fuerte y positiva</option><option>Débil o tensa</option><option>Sin relación</option><option>No aplica</option></select></div>
            <div class="sdiv">Redes de Apoyo Social</div>
            <div class="ff"><label>Relación con Vecinos</label><select id="eco-vecinos"><option value="">—</option><option>Fuerte y positiva</option><option>Débil o tensa</option><option>Sin relación</option><option>En conflicto</option></select></div>
            <div class="ff"><label>Relación con Familia Extensa (tíos, primos, etc.)</label><select id="eco-familia-ext"><option value="">—</option><option>Fuerte y positiva</option><option>Débil o tensa</option><option>Sin relación</option><option>En conflicto</option></select></div>
            <div class="ff"><label>Pertenencia a Grupos Comunitarios o Sociales</label><select id="eco-grupos"><option value="">—</option><option>Activo en grupos</option><option>Participación ocasional</option><option>Sin participación</option></select></div>
            <div class="sdiv">Trabajo y Economía</div>
            <div class="ff"><label>Relación con el entorno laboral</label><select id="eco-trabajo"><option value="">—</option><option>Estable y positiva</option><option>Inestable</option><option>Desempleo</option><option>No aplica</option></select></div>
            <div class="ff"><label>Acceso a programas de apoyo económico</label><select id="eco-apoyo-eco"><option value="">—</option><option>Recibe apoyo</option><option>En proceso de acceso</option><option>Sin acceso</option><option>No requiere</option></select></div>
            <div class="ff"><label>Observaciones del Ecomapa</label><textarea id="eco-obs" placeholder="Describe las principales redes de apoyo y tensiones identificadas..."></textarea></div>
          </div>
        </div>
    ...
    <!-- ═══ FORMULARIO 3: MACRO ═══════════════════════════
         Spreadsheet: SHEETS_URLS[municipio].macro
         ═══════════════════════════════════════════════ -->
...
// (USERS, MUNIS, SHEETS_URLS, getSheetUrl vienen de config.js)
...
// Clave: ebs_{tipo}_{municipio} → array de registros guardados
// Clave: ebs_p_{tipo}_{municipio} → array de registros pendientes de sync
...
function setRecs(m, t, arr) { localStorage.setItem(storageKey(m, t), JSON.stringify(arr)); }
function setPend(m, t, arr) { localStorage.setItem(storagePendKey(m, t), JSON.stringify(arr)); }
...
function updateSync() {
  ...
  document.getElementById('sdot').className = 'sdot ' + (online ? 'online' : 'offline');
  document.getElementById('slabel').textContent = online
    ? 'Conectado · Sincronización activa'
    : 'Sin conexión · Guardando localmente';
  document.getElementById('spill').style.display = total > 0 ? 'inline' : 'none';
  document.getElementById('spill').textContent = `${total} pendiente${total !== 1 ? 's' : ''}`;
  document.getElementById('bsync').style.display = (total > 0 && online) ? 'inline' : 'none';
...
// Cada formulario se envía al spreadsheet correspondiente
// según getSheetUrl(municipio, tipo) definido en config.js
...
async function syncAll() {
  ...
  for (const m of munis) {
    for (const t of TIPOS) {
      ...
      const url = getSheetUrl(m, t); // ← URL específica por municipio Y formulario
      if (!url) {
        // URL no configurada aún → dejar en cola
        continue;
      }
...
function clearF(tipo) {
  if (tipo === 'carto') {
    ['c1-casa','c1-familia','c1-obs','c1-idfam','c1-coord'].forEach(i => document.getElementById(i).value = '');
    ...
    document.querySelectorAll('#sub-adgar select, #sub-adgar textarea').forEach(el => el.value = '');
    document.querySelectorAll('#sub-zarit select, #sub-zarit textarea').forEach(el => el.value = '');
    document.querySelectorAll('#sub-ecomapa select, #sub-ecomapa textarea').forEach(el => el.value = '');
...
async function saveR(tipo) {
  ...
  // Validar y agregar campos específicos por tipo
  if (tipo === 'carto') {
    ...
    Object.assign(registro, { subData });
  ...
  recs.unshift(registro);
  setRecs(CM, tipo, recs);

  // Agregar a cola de sincronización (sin la foto en base64 para ahorrar espacio)
...
function renderRecs() {
  ...
  lista.innerHTML = todos.map(r => {
    const syncBadge = r.synced
      ? `<span class="sbadge s">☁️</span>`
      : `<span class="sbadge p">⏳</span>`;
    ...
    const subtitulo = r.tipo === 'carto'
      ? (r.idFam || `Fam. ${r.familia}`)
      : r.tipo === 'recoleccion'
      ? `${r.personas || '?'} personas · ${r.estrato || 'Sin estrato'}`
    ...
    return `<div class="rcard" id="rc-${r.id}">
      <div class="rcard-head" onclick="togRec('${r.id}')">
        ...
        <div class="rcard-right">${syncBadge}${riesgoBadge}<span class="rchev">▼</span></div>
      </div>
      <div class="rbody">
        ${buildFields(r)}
        <div class="ract">
...
function buildFields(r) {
  ...
  if (r.tipo === 'recoleccion') {
    return `
      <div class="rfield"><strong>Código</strong>${r.codigo || '—'}</div>
      <div class="rfield"><strong>Personas</strong>${r.personas || '—'}</div>
      <div class="rfield"><strong>Estrato</strong>${r.estrato || '—'}</div>
      <div class="rfield"><strong>Vivienda</strong>${r.vivienda || '—'}</div>
      <div class="rfield"><strong>Salud</strong>${r.salud || '—'}</div>
      <div class="rfield"><strong>Menores 5a</strong>${r.menores || '—'}</div>
      <div class="rfield" style="grid-column:1/-1"><strong>Servicios</strong>${r.servicios || '—'}</div>
      <div class="rfield" style="grid-column:1/-1"><strong>Enfermedades</strong>${r.enfermedades || '—'}</div>`;
  }
  // MACRO
...
function saveEdit() {
  ...
  pendientes.push({ ...r, foto: r.foto ? '✅ Tiene foto' : 'Sin foto', integrantes: r.integrantes || [] });
    ...
    <div class="frow3">
      <div class="ff">
        ...
        <select id="fg-f${n}-parentesco">
          ...
          <option value="principal" ${n === 1 ? 'selected' : ''}>Persona principal</option>
          <option value="pareja">Pareja</option>
          <option value="padre">Padre de principal</option>
          <option value="madre">Madre de principal</option>
          <option value="hijo">Hijo/a de principal</option>
          <option value="abuelo_paterno">Abuelo paterno de principal</option>
          <option value="abuela_paterna">Abuela paterna de principal</option>
          <option value="abuelo_materno">Abuelo materno de principal</option>
          <option value="abuela_materna">Abuela materna de principal</option>
          <option value="hermano">Hermano/a de principal</option>
...
function dibujarFamiliograma() {
  ...
  function drawPerson(x, y, person, genero, isPrincipal) {
    ...
    ctx.lineWidth = 2;
    ctx.fillStyle = isPrincipal ? '#fef9c3' : '#fff';
    if (genero === 'F') {
      ctx.beginPath();
    ...
    if (anio) {
      ...
      ctx.fillText(anio, x, y - 18);
    }
    if (nombre) {
      ctx.font = 'bold 9px DM Sans, sans-serif';
      ctx.fillStyle = colorText;
      ctx.textAlign = 'center';
      ctx.fillText(shortName(nombre), x, y + 22);
      if (isPrincipal) {
        ctx.font = 'bold 9px DM Sans, sans-serif';
        ctx.fillStyle = '#92400e';
        ctx.fillText('CASO INDICE', x, y + 34);
      }
    }
  }
  ...
  function drawCouple(p1x, p2x, y, relationType) {
    const lineStyle = relationType === 'comprometidos' ? 'dashed' : 'solid';
    drawLine(p1x + 12, y, p2x - 12, y, lineStyle);
  ...
  const principalRaw = miembros.find(m => m.parentesco === 'principal') || miembros[0] || { nombre: '', anio: '', estado: '', genero: 'M' };
  const principal = { ...principalRaw, genero: principalRaw.genero || 'M' };
  const pareja = pickFirst(miembros, 'pareja', principal.genero === 'F' ? 'M' : 'F');
  const abueloPaterno = pickFirst(miembros, 'abuelo_paterno', 'M');
  const abuelaPaterna = pickFirst(miembros, 'abuela_paterna', 'F');
  const abueloMaterno = pickFirst(miembros, 'abuelo_materno', 'M');
  const abuelaMaterna = pickFirst(miembros, 'abuela_materna', 'F');
  const padre = pickFirst(miembros, 'padre', 'M');
  const madre = pickFirst(miembros, 'madre', 'F');
  ...
  const pMidX = W * 0.32;
  const mMidX = W * 0.68;
  const abueloDx = Math.max(34, Math.min(58, W * 0.08));

  const abpX = pMidX - abueloDx;
  const abmX = pMidX + abueloDx;
  const abmpX = mMidX - abueloDx;
  const abmmX = mMidX + abueloDx;
  const padreX = pMidX;
  const madreX = mMidX;
  const principalX = W * 0.5;
  const parejaX = principalX + 90;

  ctx.save();
  ctx.fillStyle = frameFill;
  ctx.strokeStyle = frameStroke;
  ctx.lineWidth = 1;
  ctx.fillRect(8, 8, W - 16, H - 50);
  ctx.strokeRect(8, 8, W - 16, H - 50);
  ctx.restore();

  if (hasData(abueloPaterno) || hasData(abuelaPaterna)) {
    drawCouple(abpX, abmX, gen1y, 'matrimonio');
    drawLine((abpX + abmX) / 2, gen1y + 12, padreX, gen2y - 14);
  }
  if (hasData(abueloMaterno) || hasData(abuelaMaterna)) {
    drawCouple(abmpX, abmmX, gen1y, 'matrimonio');
    drawLine((abmpX + abmmX) / 2, gen1y + 12, madreX, gen2y - 14);
  }

  drawPerson(abpX, gen1y, abueloPaterno, 'M');
  drawPerson(abmX, gen1y, abuelaPaterna, 'F');
  drawPerson(abmpX, gen1y, abueloMaterno, 'M');
  drawPerson(abmmX, gen1y, abuelaMaterna, 'F');

  if (hasData(padre) || hasData(madre)) drawCouple(padreX, madreX, gen2y, 'matrimonio');
  drawPerson(padreX, gen2y, padre, 'M', false);
  drawPerson(madreX, gen2y, madre, 'F', false);

  if (hasData(padre) || hasData(madre)) {
    drawLine((padreX + madreX) / 2, gen2y + 12, principalX, gen3y - 56);
  }

  if (hasData(principal) || hasData(pareja)) {
    drawCouple(principalX, parejaX, gen3y, relacion);
  }
  drawPerson(principalX, gen3y, principal, principal.genero || 'M', true);
  if (hasData(pareja)) drawPerson(parejaX, gen3y, pareja, pareja.genero || 'F', false);

  const hijos = pickMany(miembros, 'hijo', 'M').filter(h => hasData(h));
  const hermanos = pickMany(miembros, 'hermano', 'M').filter(h => hasData(h));
  const otros = pickMany(miembros, 'otro', 'M').filter(h => hasData(h));
  ...
  if (hijosConDatos.length && (hasData(principal) || hasData(pareja))) {
    ...
    const dropY = gen3y + 36;
    drawLine(coupleMidX, gen3y + 12, coupleMidX, dropY);

    const spacing = Math.max(46, Math.min(88, (W - 80) / Math.max(hijosConDatos.length, 2)));
    const startX = coupleMidX - (spacing * (hijosConDatos.length - 1)) / 2;
    if (hijosConDatos.length > 1) {
      drawLine(startX, dropY, startX + spacing * (hijosConDatos.length - 1), dropY);
    }

    hijosConDatos.forEach((h, idx) => {
      const hx = hijosConDatos.length === 1 ? coupleMidX : startX + spacing * idx;
      const hy = gen3y + 92;
      drawLine(hx, dropY, hx, hy - 14);
      drawPerson(hx, hy, h, h.genero, false);
    });
  }
  ...
  if (hermanos.length) {
    const yH = gen3y;
    const spacingH = 62;
    const startXH = principalX - spacingH * hermanos.length;
    ctx.font = '10px DM Sans, sans-serif';
    ctx.fillStyle = '#64748b';
    ctx.textAlign = 'left';
    ctx.fillText('Hermanos/as', Math.max(12, startXH), yH - 22);
    hermanos.forEach((h, idx) => {
      const x = startXH + spacingH * idx;
      if (x > 20 && x < W - 20) drawPerson(x, yH, h, h.genero, false);
    });
  }
  ...
  if (otros.length) {
    ...
    ctx.strokeRect(12, boxY, W - 24, 44);
    ctx.fillRect(12, boxY, W - 24, 44);
    ctx.fillStyle = '#64748b';
    ctx.font = '10px DM Sans, sans-serif';
    ctx.fillText('Otros familiares:', 18, boxY + 14);
    ctx.fillStyle = '#1a2332';
    ctx.font = 'bold 10px DM Sans, sans-serif';
    const txt = otros.map(o => shortName(o.nombre || 'Sin nombre')).slice(0, 5).join('  |  ');
    ctx.fillText(txt || '—', 18, boxY + 30);
    ctx.restore();
  }
  ...
  ctx.fillStyle = '#64748b';
  ctx.textAlign = 'left';
  ctx.fillText('□ Masculino   ○ Femenino   X Fallecido/a   Amarillo: caso indice', 12, H - 6);
}
...
function bindFamiliogramaEvents() {
  ...
  document.querySelectorAll(selector).forEach(el => {
    ...
    if (el.id.includes('-parentesco')) {
      el.addEventListener('change', () => {
        if (el.value !== 'principal') return;
        document.querySelectorAll('select[id$="-parentesco"]').forEach(other => {
          if (other !== el && other.value === 'principal') other.value = '';
        });
        dibujarFamiliograma();
      });
    }
...
const ZARIT_ITEMS = [
  ...
  '¿Se siente tenso/a cuando tiene que cuidar a su familiar?',
  '¿Se siente avergonzado/a por el comportamiento de su familiar?',
  '¿Se siente irritado/a cuando está cerca de su familiar?',
  '¿Cree que la situación actual afecta su relación con amigos u otros familiares?',
  ...
  '¿Siente que no tiene tanta intimidad como quisiera a causa de su familiar?',
  '¿Cree que su vida social se ha visto afectada por tener que cuidar a su familiar?',
  '¿Se siente incómodo/a por distanciarse de sus amistades por cuidar a su familiar?',
  '¿Cree que su familiar le considera a usted la única persona que le puede cuidar?',
  '¿Cree que no tiene suficiente dinero para cuidar a su familiar?',
  ...
  '¿Se siente inseguro/a sobre qué hacer con su familiar?',
  '¿Siente que debería hacer más por su familiar?',
  '¿Cree que podría cuidar mejor a su familiar?',
  'Globalmente, ¿qué grado de sobrecarga experimenta por el hecho de cuidar a su familiar?'
];
  ...
  ZARIT_ITEMS.forEach((q, idx) => {
    ...
    div.innerHTML = `
      ...
      <select id="zarit-${n}" onchange="calcZarit()" style="margin-top:5px">
        ...
        <option value="5">5 – Casi siempre</option>
      </select>`;
...
function calcZarit() {
  let total = 0;
  for (let i = 1; i <= 22; i++) {
    total += parseInt(document.getElementById('zarit-'+i)?.value || 0);
  }
  document.getElementById('zarit-puntaje').textContent = total;
  let interp = '';
  if (total < 22) interp = '✅ Sin sobrecarga';
  else if (total <= 46) interp = '⚠️ Sobrecarga leve';
  else interp = '🔴 Sobrecarga intensa — Se recomienda intervención';
  document.getElementById('zarit-interpretacion').textContent = interp;
}

// Init Zarit when sub-accordion opens
const origToggleSub = toggleSub;

// Override to init zarit on open
function toggleSub(id) {
  const block = document.getElementById('sub-' + id);
  const body  = document.getElementById('subbody-' + id);
  const isOpen = block.classList.contains('open');
...
function getRecoleccionData() {
  ...
  // Zarit score
  let zaritTotal = 0;
  for (let i=1;i<=22;i++) zaritTotal += parseInt(document.getElementById('zarit-'+i)?.value||0);
  ...
  return {
    ...
    adgar: {
      banio:gv2('adgar-banio'),vestir:gv2('adgar-vestir'),sanitario:gv2('adgar-sanitario'),
      desplazamiento:gv2('adgar-desplazamiento'),continencia:gv2('adgar-continencia'),
      alimentacion:gv2('adgar-alimentacion'),dinero:gv2('adgar-dinero'),
      medicamentos:gv2('adgar-medicamentos'),telefono:gv2('adgar-telefono'),
      compras:gv2('adgar-compras'),obs:gv2('adgar-obs')
    },
    zarit: { puntaje: zaritTotal, obs: gv2('zarit-obs') },
    ecomapa: {
      salud:gv2('eco-salud'),educacion:gv2('eco-educacion'),gobierno:gv2('eco-gobierno'),
      iglesia:gv2('eco-iglesia'),vecinos:gv2('eco-vecinos'),familiaExt:gv2('eco-familia-ext'),
      grupos:gv2('eco-grupos'),trabajo:gv2('eco-trabajo'),apoyoEco:gv2('eco-apoyo-eco'),
      obs:gv2('eco-obs')
    }
  };
}
